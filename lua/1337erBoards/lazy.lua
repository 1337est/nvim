...
require("lazy").setup({
	...
	{ -- Popup menu for keymaps
		...
		config = function() -- This is the function that r uns, AFTER loading
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		dependencies = {
			...
			{ -- If encountering errors, see telescope-fzf-native README for installation instructions
				...
				-- 'cond' is a conditional used to determine whether this plugin should be
	...
	-- Adding editor coloring for hex colors
	{
