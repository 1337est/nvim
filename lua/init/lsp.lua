...
-- Helper: collect LSP names from nvim/lsp/<name>.lua on runtimepath
local function get_lsp_file_names()
    -- This searches every directory on 'runtimepath' for lsp/<name>.lua
...
-- Auto-enable all LSP configs that have a nvim/lsp/<name>.lua file
